...
export declare abstract class IAsistenciaRepository {
    ...
    abstract findByUniqueConstraint(fecha: Date, horarioId: number, alumnoId: number): Promise<Asistencia | null>;
    abstract findAll(pagination: PaginationOptions, filters?: FindAsistenciasFilters): Promise<PaginatedResult<Asistencia>>;
